  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "[&>[data-slot=select-value]_svg]:inline-block [&>[data-slot=select-value]_svg]:mr-2 [&>[data-slot=select-value]_svg]:align-[-0.2em]",
      ...
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          position === "popper" &&
            ...
            "min-w-[var(--radix-select-trigger-width)] max-w-[min(28rem,var(--radix-select-content-available-width))]",
          position === "popper" &&
