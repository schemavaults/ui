...
interface StepIndicatorSlotProps {
  className?: string;
}

function ValidIndicator({ className }: StepIndicatorSlotProps): ReactElement {
  return <Check className={cn(className, "text-green-500")} />;
}

function ActiveIndicator({ className }: StepIndicatorSlotProps): ReactElement {
  return (
    <div
      className={cn(
        className,
...
function InvalidIndicator({ className }: StepIndicatorSlotProps): ReactElement {
  return <X className={cn(className, "text-red-500")} />;
}

function UnfilledIndicator({
  className,
}: StepIndicatorSlotProps): ReactElement {
  return <div className={cn("bg-gray-300 rounded-full", className)} />;
}

function NoIndicator({ className }: StepIndicatorSlotProps): ReactNode {
  void className;
  return null;
}
...
export function StepsIndicator({}: StepsIndicatorProps): ReactElement {
  ...
  return (
    ...
    >
      {steps.map((step, index): ReactElement => {
        return (
          <li
